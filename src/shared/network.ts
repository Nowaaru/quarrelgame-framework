...
export namespace Server {
    ...
    interface MatchFunctions {
        ...
        */
        ...
        GetCurrentMatch(): {
            ...
            /** The match's current state. */
            State: MatchState<Entity.PlayerCombatantAttributes, Entity.EntityAttributes>; 
    ...
    interface MatchEvents {
        MatchParticipantRespawned(participantId: string): boolean;
    }
...
export const GlobalEvents = Networking.createEvent<Server.Events, Client.Events>();
export const GlobalFunctions = Networking.createFunction<Server.Functions, Client.Functions>();
